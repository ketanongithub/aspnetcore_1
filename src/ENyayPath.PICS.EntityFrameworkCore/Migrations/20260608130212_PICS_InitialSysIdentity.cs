...
{
    /// <inheritdoc />
    public partial class PICS_InitialSysIdentity : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PricePerYear = table.Column<decimal>(type: "decimal(18,2)", nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    TenancyName = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Code = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    ...
                    EditionId = table.Column<int>(type: "int", nullable: false),
                    EditionId1 = table.Column<int>(type: "int", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SysTenants_SysEditions_EditionId1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SysOrganizationUnitRoles", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SysOrganizationUnitRoles_SysOrganizationUnits_OrganizationUnitId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_SysUserOrganizationUnits_SysOrganizationUnits_OrganizationUnitId",
                        column: x => x.OrganizationUnitId,
                        principalTable: "SysOrganizationUnits",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SysFeatures_EditionId",
                table: "SysFeatures",
                column: "EditionId");

            migrationBuilder.CreateIndex(
                name: "IX_SysOrganizationUnitRoles_OrganizationUnitId",
                table: "SysOrganizationUnitRoles",
                column: "OrganizationUnitId");

            migrationBuilder.CreateIndex(
                name: "IX_SysTenants_EditionId1",
                table: "SysTenants",
                column: "EditionId1");

            migrationBuilder.CreateIndex(
                name: "IX_SysUserOrganizationUnits_OrganizationUnitId",
